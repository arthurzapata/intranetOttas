...
const base='/mia/rrhh/maestros/centros-ensenanza'
...
export function listarPaisesCentro(){return apiRequest<UbigeoOption[]>('/mia/rrhh/maestros/paises/opciones')}
export function departamentosPorPais(id:number){return apiRequest<UbigeoOption[]>(`/mia/rrhh/maestros/paises/${id}/departamentos`)}
export function provinciasPorDepartamento(id:number){return apiRequest<UbigeoOption[]>(`/mia/rrhh/maestros/departamentos/${id}/provincias`)}
export function distritosPorProvincia(id:number){return apiRequest<UbigeoOption[]>(`/mia/rrhh/maestros/provincias/${id}/distritos`)}
