...
const base='/mia/rrhh/maestros/cursos-capacitaciones'
...
export function listarCentrosActivos(){return apiRequest<CentroOption[]>('/mia/rrhh/maestros/centros-ensenanza/opciones')}
