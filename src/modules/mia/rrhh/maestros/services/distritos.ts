...
const base='/lecturita/mia/rrhh/maestros/distritos'
...
export function listarProvinciasActivas(){return apiRequest<ProvinciaOption[]>('/lecturita/mia/rrhh/maestros/provincias/opciones')}
