...
const base='/mia/rrhh/maestros/provincias'
...
export function listarDepartamentosActivos(){return apiRequest<DepartamentoOption[]>('/mia/rrhh/maestros/departamentos/opciones')}
